...
def main():
    ...
    #Position 
    spos.pose.position.x, spos.pose.position.y, spos.pose.position.z = 0.585, 0.31, 0.04
    ...
    quate = get_quaternion_from_euler(-math.pi, 0, -math.pi/2+0.4)
    ...
    robot.ur5_arm.set_goal_position_tolerance(0.0001)
    ...
    rospy.sleep(1.0)
    rospy.loginfo('POSITION: {}'.format(robot.ur5_arm.get_current_pose().pose))
